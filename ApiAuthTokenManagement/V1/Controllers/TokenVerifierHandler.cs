...
{
    public class TokenVerifierHandler
    {
        private readonly IServiceProvider _serviceProvider;

        //Initialise services
        public TokenVerifierHandler()
        {
        ...
        public TokenVerifierHandler(IServiceProvider serviceProvider)
        {
        ...
        public APIGatewayCustomAuthorizerResponse VerifyToken(APIGatewayCustomAuthorizerRequest request)
        {
            ...
            LambdaLogger.Log("key: " + request.RequestContext);
            try
            {
