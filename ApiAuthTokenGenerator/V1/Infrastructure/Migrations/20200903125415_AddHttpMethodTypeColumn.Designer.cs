...
namespace ApiAuthTokenGenerator.V1.Infrastructure.Migrations
{
    ...
    [Migration("20200903125415_AddHttpMethodTypeColumn")]
    partial class AddHttpMethodTypeColumn
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiAuthTokenGenerator.V1.Infrastructure.ApiEndpointNameLookup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("ApiAuthTokenGenerator.V1.Infrastructure.ApiNameLookup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("ApiAuthTokenGenerator.V1.Infrastructure.AuthTokens", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("ApiAuthTokenGenerator.V1.Infrastructure.ConsumerTypeLookup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
